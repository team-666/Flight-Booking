...
export class ScheduledFlightService {
  ...
  addScheduleFlight(scheduleFlight:ScheduledFlight,srcAirport,dstnAirport,deptDateTime,arrDateTime){
   ...
   // console.log(form);
    return this.http.post('http://localhost:8092/scheduledFlight/add?',form,{params});
  }

  searchScheduledFlight(scheduledFlightId: number) {
    return this.http.get('http://localhost:8092/scheduledFlight/search?flightId='+scheduledFlightId);
  }

  showScheduleFlights(): Observable<any> {
    return this.http.get('http://localhost:8092/scheduledFlight/viewAll');
  }

  removeScheduleFlight(scheduleFlightId:number){
    return this.http.delete('http://localhost:8092/scheduledFlight/delete?flightId='+scheduleFlightId);
 }
 ...
 modifyScheduledFlight(scheduleFlight:ScheduledFlight){
   ...
   return this.http.put('http://localhost:8092/scheduledFlight/modify?',mForm);
 }
